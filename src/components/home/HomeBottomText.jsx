...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-2 '>
      <p className='absolute lg:w-[17vw] w-64 lg:right-20 right-20 bottom-60  lg:bottom-50 font-[font1] lg:text-md lg:font-normal text-xs lg:leading-relaxed leading-tight'>
      ...
      <div className='relative overflow-hidden w-[30%]  group lg:border-3 border-2 hover:border-[#D3FD50] lg:h-30 flex items-center justify-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase duration-300 ease-out cursor-pointer' >
      ...
      <Link className='relative z-10 text-[4vw] w-[30%]  text-center transition-colors duration-300 group-hover:text-black' to='/contact'>
      <div className='relative overflow-hidden  group lg:border-3 border-2 hover:border-[#D3FD50] lg:h-30 flex items-center justify-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase duration-300 ease-out cursor-pointer' >
         <span className='absolute inset-0 bg-[#D3FD50] -translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out'></span>
